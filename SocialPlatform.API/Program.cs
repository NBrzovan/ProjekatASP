...
using SocialPlatform.Implementation.Logging;
using SocialPlatform.Implementation.Mappings;
...
builder.Services.AddTransient(x => new SocialPlatformContext(settings.ConnectionString));
builder.Services.AddTransient<JwtTokenCreator>();

builder.Services.AddHttpContextAccessor();
builder.Services.AddUsecaseAndValidator();
...
builder.Services.AddTransient<IApplicationActorProvider>(x =>
{
    ...
    var context = x.GetService<SocialPlatformContext>();
...
{
    conf.AddProfile<TopicProfile>();
    conf.AddProfile<TagProfile>();
    conf.AddProfile<CommunityProfile>();
    conf.AddProfile<QuestionProfile>();
    conf.AddProfile<UserProfile>();
    conf.AddProfile<LogProfile>();
});
